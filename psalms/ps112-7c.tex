...
\latinenglish{
	 ...
	 4. Excélsus super omnes \textbf{gen}tes \textbf{Dó}-\linebreak minus,~*
	 ...
	 7. Ut cóllocet eum \textbf{cum} prin\textbf{cí}pi-\linebreak bus,~*
		cum princípibus \textbf{pó}puli \textbf{su}i.
	
	 8. Qui habitáre facit stéri\textbf{lem} in \textbf{do}-\linebreak mo,~*

...
\latinenglish{	
	 2. Facta est Jud\'{\ae}a sanctificá\textit{ti}\textit{o} \textbf{e}-\linebreak jus,~*
	 ...
	 5. Quid est tibi, mare, \textit{quod} \textit{fu}\textbf{gís}ti:~*
		et tu, Jordánis, quia convér\textit{sus} \textit{es} \textit{re}-\linebreak \textbf{trór}sum?
	 ...
	 8. Qui convértit petram in sta\textit{gna} \textit{a}\textbf{quá}rum,~*
		et rupem in \textit{fon}\textit{tes} \textit{a}\textbf{quá}-\linebreak rum.
	 ...
	 12. Simulácra géntium argén\textit{tum}, \textit{et} \textbf{au}rum,~*
		ópera \textit{má}\textit{nu}\textit{um} \textbf{hó}min-\linebreak um.
